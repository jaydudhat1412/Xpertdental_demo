...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-20 right-4 md:bottom-24 md:right-8 z-50 p-3.5 rounded-full bg-[#25D366] text-white  hover:bg-[#20bd5a] focus:outline-none focus:ring-4 focus:ring-[#25D366]/30 border border-white/20 transition-all duration-300 flex items-center justify-center group"
    >
      <svg
