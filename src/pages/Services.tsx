...
export default function Services() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-[#050400] min-h-screen pt-12 pb-24 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-3 py-2 px-4 rounded-full bg-white dark:bg-gray-800 border border-blue-100 dark:border-blue-900/50  text-blue-700 dark:text-blue-300 text-sm font-semibold mb-6">
              ...
              {services.map((service, index) => (
                ...
                >
                   <Link 
                      ...
                      className="group flex flex-col bg-white dark:bg-[#0a0801] rounded-sm overflow-hidden  hover: hover:-translate-y-2 transition-all duration-500 border border-gray-100 dark:border-gray-800 h-full"
                    >
